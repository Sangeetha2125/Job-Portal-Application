...
export const EditUserAdmin = () => {
    ...
    return (
        <>
            ...
            <div className='bg-gray-100 min-h-screen pt-14 md:px-20 px-3 text-gray-900'>
                {loading ? <Loader /> : (
                    <div className='flex flex-col gap-3 justify-center items-center pt-28 md:pt-20'>
                        <div className='py-4 md:w-1/3 w-full px-5 shadow-md border border-gray-300 bg-white'>
                            <div className='flex gap-3 border-b border-gray-300 pb-3 text-2xl justify-center items-center'>
                            ...
                            <div className='flex gap-3 border-b border-gray-300 py-2 text-xl justify-start items-center'>
                                <div>Role:</div>
                            ...
                            <div className='flex gap-3 pt-4 py-2 text-sm justify-start items-center'>
                                <select 
                                    ...
                                    className="block w-full px-6 py-2 text-base border border-gray-300 bg-gray-100 placeholder-gray-500 text-gray-900"
                                >
                            ...
                            <div className='flex gap-3 font-semibold py-2 text-sm'>
                                <button 
                                    ...
                                    className='bg-blue-600 text-white px-6 py-2 hover:bg-blue-500 transition-colors duration-200'
                                >
                                    Update Role
                                </button>
                            </div>
